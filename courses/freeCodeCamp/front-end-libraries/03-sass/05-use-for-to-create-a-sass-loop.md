...
`@for` is used in two ways: "start through end" or "start to end". The main difference is that "start to end" _excludes_ the end number, and "start through end" _includes_ the end number.
